...
export const mockTasks: Task[] = [
  {
    ...
    description:
      "Create a responsive landing page that showcases the AI hackathon projects. Include hero section, project gallery, and registration CTA.",
    status: "in-progress",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Create complete brand guidelines including logo variations, color palette, typography, and usage examples for the hackathon.",
    status: "todo",
    priority: "medium",
    ...
    technologies: [{ id: "figma", label: "Figma", color: "bg-violet-100 text-violet-700" }],
  ...
  },
  {
    ...
    description:
      "Configure GitHub Actions for automated testing and deployment. Include staging and production environments.",
    status: "completed",
    priority: "high",
  ...
  },
  {
    ...
    description:
      "Build a real-time analytics dashboard showing participant statistics, submission rates, and leaderboard.",
    status: "todo",
    priority: "low",
  ...
  },
  {
    ...
    description:
      "Document the API endpoints, system architecture, and developer setup guide for the hackathon platform.",
    status: "in-progress",
    priority: "medium",
...
export const mockSubmissions: Submission[] = [
  {
    ...
    review: {
      decision: "approved",
      score: 92,
      feedback: "Excellent work! Clean code and great animations.",
      reviewedBy: "Organizer",
      reviewedAt: "2026-06-09T10:00:00",
    },
  },
  {
    id: "sub-002",
    taskId: "task-001",
    submittedBy: mockMembers[1],
  ...
  },
  {
    ...
    review: {
      decision: "approved",
      score: 98,
      feedback: "Perfect pipeline setup.",
      reviewedBy: "Organizer",
      reviewedAt: "2026-05-28T09:00:00",
    },
  },
];
  ...
  "task-001": [
    {
      ...
      type: "created",
      actor: "Organizer",
      description: "Task created and assigned to John & Jane",
    ...
    },
    {
      ...
      type: "updated",
      actor: "John Doe",
      description: "Status changed from Todo → In Progress",
    ...
    },
    {
      ...
      type: "submitted",
      actor: "John Doe",
      description: "Submitted GitHub repository link",
    ...
    },
    {
      ...
      type: "reviewed",
      actor: "Organizer",
      description: "Submission approved · Score: 92/100",
    ...
    },
    {
      ...
      type: "submitted",
      actor: "Jane Smith",
      description: "Submitted design assets",
  ...
  "task-003": [
    {
      ...
      type: "created",
      actor: "Organizer",
      description: "Task created and assigned to Alice & Bob",
    ...
    },
    {
      ...
      type: "submitted",
      actor: "Alice Johnson",
      description: "Submitted CI/CD pipeline implementation",
    ...
    },
    {
      ...
      type: "reviewed",
      actor: "Organizer",
      description: "Submission approved · Score: 98/100",
