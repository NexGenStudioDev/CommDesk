...
const TIME_DOTS: Record<string, string> = {
  all: "bg-gray-400",
  upcoming: "bg-sky-500",
  past: "bg-red-500",
  completed: "bg-emerald-500",
...
const STATUS_STYLES: Record<string, { bg: string; color: string; border: string }> = {
  ...
  "in-progress": {
    bg: "rgba(97, 95, 255, 0.16)",
    color: "#A7C7FF",
    border: "rgba(97, 95, 255, 0.38)",
  },
  completed: {
...
const PRIORITY_STYLES: Record<string, { bg: string; color: string; border: string }> = {
  ...
  medium: {
    bg: "var(--cd-warning-subtle)",
    color: "var(--cd-warning)",
    border: "var(--cd-warning-subtle)",
  },
  low: {
    bg: "var(--cd-primary-subtle)",
    color: "var(--cd-primary-text)",
        ...
        {mockMembers.map((m) => {
          ...
          return (
            <button
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLElement).style.backgroundColor = isSel
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] truncate" style={{ color: "var(--cd-text-muted)" }}>
                  {m.role}
                </p>
              </div>
              {isSel && (
        ...
        {isActive && (
          <>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                ((e.currentTarget as HTMLElement).style.backgroundColor = "var(--cd-danger-subtle)")
              }
              onMouseLeave={(e) =>
                ((e.currentTarget as HTMLElement).style.backgroundColor = "transparent")
              }
...
function SmartSearch({
  ...
  const suggestions = (() => {
    ...
    const items: {
      id: string;
      label: string;
      type: "title" | "tech" | "member" | "status" | "recent";
    }[] = [];
    ...
    <div className="relative shrink-0" ref={panelRef}>
      ...
      >
        <Search
          ...
          style={{ color: focused || open || value ? "var(--cd-primary)" : "var(--cd-text-muted)" }}
        />
        ...
        {value && (
          <button
            ...
            className="shrink-0 transition-colors hover:text-[var(--cd-text)]"
          ...
          >
            {suggestions.map((s) => (
              ...
              >
                ...
                <span className="px-1.5 py-0.5 rounded-md text-[8px] font-black uppercase tracking-tighter bg-[var(--cd-surface-3)] text-[var(--cd-text-muted)] group-hover:bg-[var(--cd-primary-subtle)] group-hover:text-[var(--cd-primary-text)] transition-colors">
                  {s.type}
                </span>
              </button>
            ))}
      ...
      <div className="mx-auto flex w-full max-w-[1440px] flex-wrap items-center gap-3 px-5 py-4 sm:px-8 lg:px-10">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <MemberFilter
            ...
            onChange={(ids) => onChange({ ...filters, members: ids })}
          />
        </div>
        ...
        <p className="text-xs font-medium" style={{ color: "var(--cd-text-muted)" }}>
          {hasActive ? (
            <span className="flex items-center gap-1">
              ...
              filtered results from {totalCount} total tasks
            </span>
          ) : (
