      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold border transition-all active:scale-95 hover:bg-cd-hover"
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all active:scale-95 shadow-(--cd-primary-subtle)"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 flex flex-col gap-8">
              ...
              >
                ...
                <div className="p-2">
                  {logsLoading ? (
                    <div className="p-10 text-center text-xs text-cd-text-muted flex flex-col items-center gap-3">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
              ...
              >
                <div>
                  <h3 className="text-[10px] font-black mb-4 uppercase tracking-[0.25em] text-cd-text-muted flex items-center gap-2">
