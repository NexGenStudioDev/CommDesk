        ...
        >
            ...
            <div className="relative">
              ...
              <input
                ...
                style={{
                  backgroundColor: "var(--cd-surface-2)",
                  color: "var(--cd-text)",
                  borderColor: errors.url ? undefined : "var(--cd-border)",
                }}
              />
            </div>
            {errors.url && (
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-xs" style={{ color: "var(--cd-text-muted)" }}>
              Used to create a hash signature with each payload, ensuring the request comes from
              CommDesk.
            </p>
          </div>
                  ...
                  >
                    ...
                    <div>
                      <p
                        ...
                        style={{ color: isSelected ? "var(--cd-primary-text)" : "var(--cd-text)" }}
                      >
                        {event.label}
                      </p>
                      <p
