                ...
                <td className="px-5 py-4">
                  <div className="flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      className="p-1.5 rounded-md hover:bg-cd-surface-3 transition-colors"
                    ...
                    <button
                      onClick={() => onDelete(w)}
                      className="p-1.5 rounded-md hover:bg-cd-danger-subtle hover:text-cd-danger transition-colors"
