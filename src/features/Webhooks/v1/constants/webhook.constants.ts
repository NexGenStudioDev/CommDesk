...
export const WEBHOOK_EVENTS: { id: WebhookEvent; label: string; description: string }[] = [
  ...
  },
  {
    ...
    description: "Triggered when a member account is activated.",
  },
  {
    id: "event.created",
    label: "Event Created",
    description: "Triggered when a new event is scheduled.",
  },
  {
    id: "hackathon.created",
    label: "Hackathon Created",
    description: "Triggered when a new hackathon is created.",
  },
